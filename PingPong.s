...
# This game is played by 2 players and know as pong game simulateds from real world ping pong game.
# The game is played by 2 players and each player has a paddle which can be moved up and down.
# The ball is bounced back when it hits the paddle and the player who misses the ball loses the game.
# The game is played till one of the player reaches the score of 9.
# The game can be paused by pressing the pause button on the DE1-SoC board.
# The game can be restarted by pressing the start button on the DE1-SoC board.
# The game can be reset by pressing the reset button on the DE1-SoC board.
...
1:
    ...
    nop												# Keep waiting ...
    nop												# Keep waiting ...
    nop												# Keep waiting ...nop												# Keep waiting ...
    nop												# Keep waiting ...
    nop												# Keep waiting ...
    nop												# Keep waiting ...
    nop												# Keep waiting ...nop												# Keep waiting ...
...
# this is taken from https://en.wikipedia.org/wiki/Xorshift
